...
public class DetailReadOffline extends DialogFragment {
    private Dialog dialog;
    private Activity activity;
    private DialogDetailChapterBinding binding;
    private List<ChapterSave> mList;
    private ChapterSave chapterSave;
    ...
    public DetailReadOffline(ChapterSave data, List<ChapterSave> mList) {
        this.chapterSave = data;
        this.mList = mList;
    ...
    private void initView() {
        binding.tvTitle.setText("Chapter " + chapterSave.getNumber() + ": " + chapterSave.getChapterTitle());
        binding.tvContent.setText(Html.fromHtml(chapterSave.getContent()));
